...
def graph():
    ...
    def diem():
        def s1():
            st.bar_chart(df, x = 'GENDER', y = 'S1')
            st.write('Kết luận: ')
            st.bar_chart(df, x = 'PYTHON-CLASS', y = 'S1')
            st.write('Kết luận: ')
            st.bar_chart(df, x = 'CLASS_GROUP', y = 'S1')
            st.write('Kết luận: ')
            st.bar_chart(df, x = 'KHỐI', y = 'S1')
            st.write('Kết luận: ')
            def dtbs1():
                a = 0
                A = 0
                ...
                return st.bar_chart(df, x = 'CLASS_GROUP', color = 'GENDER', barmode = 'group', y = 'ĐTB S1')
            dtbs1()
            st.write('Kết luận: ')
        def s2():
            st.bar_chart(df, x = 'GENDER', y = 'S2')
            st.write('Kết luận: ')
            st.bar_chart(df, x = 'PYTHON-CLASS', y = 'S2')
            st.write('Kết luận: ')
            st.bar_chart(df, x = 'CLASS_GROUP', y = 'S2')
            st.write('Kết luận: ')
            st.bar_chart(df, x = 'KHỐI', y = 'S2')
            st.write('Kết luận: ')
            def dtbs2():
                a = 0
                A = 0
                ...
                return st.bar_chart(df, x = 'CLASS_GROUP', color = 'GENDER', barmode = 'group', y = 'ĐTB S2')
            dtbs2()
            st.write('Kết luận: ')
        def s3():
            st.bar_chart(df, x = 'GENDER', y = 'S3')
            st.write('Kết luận: ')
            st.bar_chart(df, x = 'PYTHON-CLASS', y = 'S3')
            st.write('Kết luận: ')
            st.bar_chart(df, x = 'CLASS_GROUP', y = 'S3')
            st.write('Kết luận: ')
            st.bar_chart(df, x = 'KHỐI', y = 'S3')
            st.write('Kết luận: ')
            def dtbs3():
                a = 0
                A = 0
                ...
                return st.bar_chart(df, x = 'CLASS_GROUP', color = 'GENDER', barmode = 'group', y = 'ĐTB S3')
            dtbs3()
            st.write('Kết luận: ')
        def s4():
            st.bar_chart(df, x = 'GENDER', y = 'S4')
            st.write('Kết luận: ')
            st.bar_chart(df, x = 'PYTHON-CLASS', y = 'S4')
            st.write('Kết luận: ')
            st.bar_chart(df, x = 'CLASS_GROUP', y = 'S4')
            st.write('Kết luận: ')
            st.bar_chart(df, x = 'KHỐI', y = 'S4')
            st.write('Kết luận: ')
            def dtbs4():
                a = 0
                A = 0
                ...
                return st.bar_chart(df, x = 'CLASS_GROUP', color = 'GENDER', barmode = 'group', y = 'ĐTB S4')
            dtbs4()
            st.write('Kết luận: ')
        def s5():
            st.bar_chart(df, x = 'GENDER', y = 'S5')
            st.write('Kết luận: ')
            st.bar_chart(df, x = 'PYTHON-CLASS', y = 'S5')
            st.write('Kết luận: ')
            st.bar_chart(df, x = 'CLASS_GROUP', y = 'S5')
            st.write('Kết luận: ')
            st.bar_chart(df, x = 'KHỐI', y = 'S5')
            st.write('Kết luận: ')
            def dtbs5():
                a = 0
                A = 0
                ...
                return st.bar_chart(df, x = 'CLASS_GROUP', color = 'GENDER', barmode = 'group', y = 'ĐTB S5')
            dtbs5()
            st.write('Kết luận: ')
        def s6():
            px.box(df, x = 'GENDER', y = 'S6')
            st.write('Kết luận: ')
            px.box(df, x = 'PYTHON-CLASS', y = 'S6')
            st.write('Kết luận: ')
            px.box(df, x = 'CLASS_GROUP', y = 'S6')
            st.write('Kết luận: ')
            px.box(df, x = 'KHỐI', y = 'S6')
            st.write('Kết luận: ')
            def dtbs6():
                a = 0
                A = 0
                ...
                return st.bar_chart(df, x = 'CLASS_GROUP', color = 'GENDER', barmode = 'group', y = 'ĐTB S6')
            dtbs6()
            st.write('Kết luận: ')
        def s7():
            px.box(df, x = 'GENDER', y = 'S7')
            st.write('Kết luận: ')
            px.box(df, x = 'PYTHON-CLASS', y = 'S7')
            st.write('Kết luận: ')
            px.box(df, x = 'CLASS_GROUP', y = 'S7')
            st.write('Kết luận: ')
            px.box(df, x = 'KHỐI', y = 'S7')
            st.write('Kết luận: ')
            def dtbs7():
                a = 0
                A = 0
                ...
                return st.bar_chart(df, x = 'CLASS_GROUP', color = 'GENDER', barmode = 'group', y = 'ĐTB S7')
            dtbs7()
            st.write('Kết luận: ')
        def s8():
            px.box(df, x = 'GENDER', y = 'S8')
            st.write('Kết luận: ')
            px.box(df, x = 'PYTHON-CLASS', y = 'S8')
            st.write('Kết luận: ')
            px.box(df, x = 'CLASS_GROUP', y = 'S8')
            st.write('Kết luận: ')
            px.box(df, x = 'KHỐI', y = 'S8')
            st.write('Kết luận: ')
            def dtbs8():
                a = 0
                A = 0
                ...
                return st.bar_chart(df, x = 'CLASS_GROUP', color = 'GENDER', barmode = 'group', y = 'ĐTB S8')
            dtbs8()
            st.write('Kết luận: ')
        def s9():
            px.box(df, x = 'GENDER', y = 'S9')
            st.write('Kết luận: ')
            px.box(df, x = 'PYTHON-CLASS', y = 'S9')
            st.write('Kết luận: ')
            px.box(df, x = 'CLASS_GROUP', y = 'S9')
            st.write('Kết luận: ')
            px.box(df, x = 'KHỐI', y = 'S9')
            st.write('Kết luận: ')
            def dtbs9():
                a = 0
                A = 0
                ...
                return st.bar_chart(df, x = 'CLASS_GROUP', color = 'GENDER', barmode = 'group', y = 'ĐTB S9')
            dtbs9()
            st.write('Kết luận: ')
        def s10():
            px.box(df, x = 'GENDER', y = 'S10')
            st.write('Kết luận: ')
            px.box(df, x = 'PYTHON-CLASS', y = 'S10')
            st.write('Kết luận: ')
            px.box(df, x = 'CLASS_GROUP', y = 'S10')
            st.write('Kết luận: ')
            px.box(df, x = 'KHỐI', y = 'S10')
            st.write('Kết luận: ')
            def dtbs10():
                a = 0
                A = 0
                ...
                return st.bar_chart(df, x = 'CLASS_GROUP', color = 'GENDER', barmode = 'group', y = 'ĐTB S10')
            dtbs10()
            st.write('Kết luận: ')
        def gpa():
            px.box(df, x = 'GENDER', y = 'GPA')
            st.write('Kết luận: ')
            px.box(df, x = 'PYTHON-CLASS', y = 'GPA')
            st.write('Kết luận: ')
            px.box(df, x = 'CLASS_GROUP', y = 'GPA')
            st.write('Kết luận: ')
            px.box(df, x = 'KHỐI', y = 'GPA')
            st.write('Kết luận: ')
            def dtbgpa():
                a = 0
                A = 0
                ...
                return st.bar_chart(df, x = 'CLASS_GROUP', color = 'GENDER', barmode = 'group', y = 'ĐTB GPA')
            dtbgpa()
            st.write('Kết luận: ')
        point = st.radio('Điểm từng session', ('S1', 'S2', 'S3', 'S4', 'S5', 'S6', 'S7', 'S8', 'S9', 'S10', 'GPA'))
        if point == 'S1':
            st.write(s1)
        elif point == 'S2':
            st.write(s2)
